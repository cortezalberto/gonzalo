  ...
  persist(
    (set, get) => ({
      ...
      submitOrder: async () => {
        ...
        // Capture cart items before async operation
        ...
        try {
          ...
          const newOrder: OrderRecord = {
            id: orderId,
            round_number: 0, // Will be set in functional update
            items: cartItems,
            subtotal,
            status: 'submitted',
          ...
          set((currentState) => {
            ...
            newOrder.round_number = newRound

            return {
              session: { ...currentState.session, shared_cart: [] },
